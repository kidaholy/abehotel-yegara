 ...
 */
function calculateStoreValue(items) {
 ...
 */
function testCase2MultipleItems() {
  const items = [
    {
      id: "1",
      name: "Item 1",
 ...
 */
function testCase3AfterTransfer() {
  // Before transfer
  const itemBefore = {
    id: "1",
    name: "Item",
 ...
 */
function propertyZeroQuantityContributesZero() {
  const testCases = [
 ...
 */
function propertyCalculationUsesStoreQuantity() {
  const item1 = {
    id: "1",
    name: "Item",
    storeQuantity: 10,
 ...
 */
function propertyLinearityOfAggregation() {
  const items = [
    {
      id: "1",
      name: "Item 1",
