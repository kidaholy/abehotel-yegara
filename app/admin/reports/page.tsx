...
export default function ReportsPage() {
    ...
    const exportFinancialReport = () => {
        const data = [
            ...
            { Metric: "  - Food Sales Revenue", Type: "SUBSET", Amount: `${foodRevenue.toLocaleString()} ETB`, Description: "Revenue generated from food items" },
            { Metric: "  - Drinks Sales Revenue", Type: "SUBSET", Amount: `${drinksRevenue.toLocaleString()} ETB`, Description: "Revenue generated from beverages" },
            { Metric: "  - Reception Revenue", Type: "SUBSET", Amount: `${receptionRevenue.toLocaleString()} ETB`, Description: "Approved room bookings for this period" },
            ...cashierRevenue.map(c => ({
                Metric: `- Staff: ${c.name}`,
                Type: "BREAKDOWN",
                Amount: `${c.amount.toLocaleString()} ETB`,
                Description: `Sales attributed to ${c.name}`
            })),
